package com.journey.common_utils.bluetooth
...
import com.journey.common_utils.other.type.emptyBlock
...
class BluetoothController(
    private var context: Context, private var adapter: BluetoothAdapter,
