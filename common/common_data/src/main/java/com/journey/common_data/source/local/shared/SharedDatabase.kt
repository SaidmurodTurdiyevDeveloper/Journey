package com.journey.common_data.source.local.shared
...
class SharedDatabase(
    ...
    var currentJourney: Int
        get() = getIntData("current_journey_integer")
        set(value) = setIntData("current_journey_integer", value)
